...
-- ----------------------------
-- Table structure for fms_group_function_setting
-- ----------------------------
DROP TABLE IF EXISTS `fms_group_function_setting`;
CREATE TABLE `fms_group_function_setting`  (
