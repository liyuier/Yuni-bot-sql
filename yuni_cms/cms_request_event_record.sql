...
-- ----------------------------
-- Table structure for cms_request_event_record
-- ----------------------------
DROP TABLE IF EXISTS `cms_request_event_record`;
CREATE TABLE `cms_request_event_record`  (
