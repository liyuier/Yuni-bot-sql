...
-- ----------------------------
-- Table structure for cms_function_call_record
-- ----------------------------
DROP TABLE IF EXISTS `cms_function_call_record`;
CREATE TABLE `cms_function_call_record`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT 'id',
  `time` datetime NOT NULL COMMENT '功能调用时间',
  `group_id` bigint NULL DEFAULT NULL COMMENT '群组ID',
  `user_id` bigint NOT NULL COMMENT '调用功能的用户ID',
